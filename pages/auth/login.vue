...
<template>
   <div class="px-4 py-8 bg-white rounded shadow">
      <h4 class="text-xl mb-2 font-bold text-center">Tizimga kirish</h4>
      <p class="text-xs font-medium mb-5 text-center">Kirish uchun foydalanuvchi va parolni kiriting.</p>
            ...
            <div class="flex flex-col space-y-3">
               <div class="flex flex-col space-y-2">
                  <VField name="username" rules="required|max:60|min:3" v-model="form.username" v-slot="{ errors }">
                     <Label for="username" class="text-xs font-medium">Foydalanuvchi nomi</Label>
                     <Input
                        id="username"
                        type="text"
                     ...
                     />
                     <span class="text-xs text-red-600" v-if="errors[0]">{{ errors[0] }}</span>
                  </VField>
               </div>
               <div class="flex flex-col space-y-2">
                  ...
                  <Dialog>
                     <DialogTrigger as-child>
                        <Button variant="link" size="sm" class="text-primary justify-start px-0"> Parolni unitdingizmi? </Button>
                     </DialogTrigger>
                     <DialogContent>
                        <DialogHeader>
                                 ...
                                 <div class="flex flex-col">
                                    ...
                                    >
                                       ...
                                       <div class="relative">
                                          <Input
                                             id="password"
                                             :type="resetPasswordField ? 'password' : 'text'"
                                          ...
                                          <span class="absolute top-1/2 -translate-y-1/2 end-0 flex items-center justify-center px-3 cursor-pointer">
                                             <svg
                                                ...
                                                class="p-icon"
                                                aria-hidden="true"
                                                @click="resetPasswordSee"
                                                v-if="resetPasswordField"
                                             >
                                                <path
                                                   fill-rule="evenodd"
                                                   clip-rule="evenodd"
               ...
               <Button type="submit" class="w-full">Tizimga kirish</Button>
            </div>
         </form>
      </VForm>
      <div class="flex items-center flex-col mt-6">
         <div class="flex flex-wrap justify-center sm:justify-between items-center">
            <NuxtLink to="/auth/register"><Button variant="link"> Ro'yxatdan o'tish </Button></NuxtLink>
         </div>
      </div>
   </div>
</template>
