         ...
         <div class="grid gap-6 sm:grid-cols-2 lg:grid-cols-3 2xl:grid-cols-4">
            <div class="group relative flex h-full flex-col overflow-hidden rounded-md border transition hover:bg-muted/30 cursor-pointer">
               <div class="relative w-full overflow-hidden rounded-t-md border-b">
                  <img
                     src="https://fozilov.uz/_next/image?url=https%3A%2F%2Futfs.io%2Ff%2F3bb5e088-4de1-4781-8564-4aff4990c5a8-mdx3jd.png&w=3840&q=75"
                     alt=""
                     class="w-full object-cover"
                  />
               </div>
               <div class="space-y-3 p-3">
                  <div class="line-clamp-2 text-sm font-medium transition group-hover:text-primary md:text-xl">Vue &amp; Nuxt asoslari</div>
                  <div class="flex items-center space-x-5 text-sm">
                     ...
                     <div class="flex items-center space-x-2">
                        ...
                        <span>27 ta video</span>
                     </div>
                  </div>
                  <p class="text-base font-medium text-slate-700 dark:text-slate-200">300 000 so‘m</p>
               </div>
            </div>
         </div>
      </div>
