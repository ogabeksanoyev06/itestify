...
import { useForwardPropsEmits, SelectRoot, SelectValue, useForwardProps, SelectTrigger, SelectIcon, SelectPortal, SelectContent, SelectViewport, SelectGroup, SelectItem, SelectItemIndicator, SelectItemText, SelectLabel, SelectScrollUpButton, SelectScrollDownButton } from 'radix-vue';
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      _push(ssrRenderComponent(unref(SelectTrigger), mergeProps(unref(forwardedProps), {
        class: unref(cn)(
          "flex h-10 w-full items-center justify-between whitespace-nowrap rounded-md border border-input bg-transparent transition-colors duration-500 px-3 py-2 text-sm shadow-sm ring-offset-background placeholder:text-muted-foreground focus:outline-none focus:ring-1 focus:ring-ring disabled:cursor-not-allowed disabled:opacity-50 [&>span]:line-clamp-1",
          props.class
        )
      }, _attrs), {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
...
export { _sfc_main$8 as _, _sfc_main$6 as a, _sfc_main$7 as b, _sfc_main$5 as c, _sfc_main$4 as d, _sfc_main$2 as e, _sfc_main$3 as f };
//# sourceMappingURL=SelectScrollDownButton-DyBSBm8i.mjs.map
